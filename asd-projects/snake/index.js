...
function makeApple() {
  ...
  */
      ...
      for (var i = 0; i < snake.body.length - 1; i++) {
        ...
        var nextSegment = snake.body[i + 1];

        // Example logic: move the current segment to where the next one is
  ...
  */
        ...
        if (head.row === apple.row && head.column === apple.column) {
          return true;
        } else {
          return false;
        }
  ...
  */
        function hasCollidedWithSnake() {
          ...
          for (let i = 1; i < snake.body.length; i++) {
            ...
            if (head.row === bodyPart.row && head.column === bodyPart.column) {
...
*/
    ...
    */
    ...
    let bodySquare = snake.body[i];
 if (bodySquare.row === randomPosition.row && bodySquare.column === randomPosition.column) {
    }
